...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- PULSANTI -->
                    <div style="position: absolute; width: 100%; bottom: 0px; text-align: center; height: 7%">
                        ...
                        <asp:Button ID="btnVisualizzaFattura" runat="server" Text="Visualizza Fattura" class=" w3-btn w3-white w3-border w3-border-cyan w3-round-large" OnClick="btnVisualizzaFattura_Click" OnClientClick="$('.loader').show();" Visible="false" Style="padding: 7px 10px" />
                        ...
                        <asp:Button ID="btn_annulla" runat="server" Text="Annulla" class="w3-btn w3-white w3-border w3-border-red w3-round-large" OnClick="btn_annulla_Click" OnClientClick="$('.loader').show();" Style="padding: 7px 10px;" />
                    </div>

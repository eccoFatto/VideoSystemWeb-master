    ...
    <table style="width: 99%; height: 100%;">
        <tr>
            ...
            <td style="width: 20%; vertical-align: top;">
                ...
                <div class="w3-container" style="margin-left: 20px; margin-top:15px; text-align: center">
                    <asp:Button runat="server" CssClass="w3-bar-item w3-button w3-green w3-border w3-round" ID="btnStampaGiornata" Text="Stampa Giornata" OnClick="btnStampaGiornata_Click" OnClientClick="$('.loader').show();" />
                </div>
            </td>
        </tr>
    </table>

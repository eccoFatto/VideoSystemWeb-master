...
<div id="modalGiornata" class="w3-modal">
    <div class="w3-modal-content  w3-animate-zoom " style="position: fixed; top: 5%; width: 70%; left: 15%; overflow: auto; height: 90%; background-color: transparent">
        ...
        <div class="w3-bar w3-light-grey">
            ...
            <asp:Button ID="btnStampaGiornata" runat="server" Text="Stampa" class="w3-bar-item w3-btn w3-white w3-border w3-border-green w3-round-large " Style="font-size: smaller; padding: 4px 8px" OnClick="btnStampaGiornata_Click" />

    ...
    public class Anag_Collaboratori_DAL : Base_DAL
    {
        ...
        public Esito RemoveCollaboratore(int idCollaboratore)
        {
            ...
            try
            {
                using (System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(sqlConstr))
                {
                    using (System.Data.SqlClient.SqlCommand StoreProc = new System.Data.SqlClient.SqlCommand("RemoveCollaboratore"))
                    {
                        using (System.Data.SqlClient.SqlDataAdapter sda = new System.Data.SqlClient.SqlDataAdapter())
                        {
                            StoreProc.Connection = con;
                            ...
                            System.Data.SqlClient.SqlParameter id = new System.Data.SqlClient.SqlParameter("@id", idCollaboratore);
                            id.Direction = ParameterDirection.Input;
                            StoreProc.Parameters.Add(id);
            ...
            {
                esito.Codice = Esito.ESITO_KO_ERRORE_SCRITTURA_TABELLA;
                esito.Descrizione = "Anag_Collaboratori_DAL.cs - RemoveCollaboratore " + Environment.NewLine + ex.Message + Environment.NewLine + ex.StackTrace;
            }

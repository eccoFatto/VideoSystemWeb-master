<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="StampaCollaboratori.aspx.cs" Inherits="VideoSystemWeb.REPORT.StampaCollabortori" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <label><asp:Label ID="lblStampaConllaboratori" runat="server" Text="STAMPA COLLABORATORI" ForeColor="Teal"></asp:Label></label>
            ...
            <div class="w3-row-padding" style="position:relative;">
                ...
                <div class="w3-quarter">
                    ...
                    <div class="w3-third" style="padding-right:10px">
                        ...
                        <asp:CheckBox ID="chk_Fornitore" runat="server" class="w3-input w3-border"/>
                    </div>
                </div>
            </div>
